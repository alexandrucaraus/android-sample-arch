...
import eu.acaraus.news.presentation.articles.list.ArticlesListViewModel
...
class ArticleListViewModelTest : UnitTest {

    @get:Rule
    override val koinUnitTestRule = KoinUnitTestRule(ArticleListViewModelTestModule().module)
